/*
 * LOSS_SQRHINGE_NATIVE.CPP	
 *
 * The calling syntax is:
 *
 *		[loss, idxs] = loss_sqrhinge_native(t,delta_y_ybar,delta_psis,delta_psis_idxs) 
 *
 * Compile using
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {		  
  ...
  const	mxArray *params = prhs[arg];
	...
	const mxArray *alpha_ptr = mxGetField(params,0, "sqrhinge_alpha");
  double alpha = 0.1;
	if (alpha_ptr!=NULL) {

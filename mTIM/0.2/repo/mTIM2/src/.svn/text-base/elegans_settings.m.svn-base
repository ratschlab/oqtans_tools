...
fprintf('Elegans test with permitted feature ranges.\n');
% options for enforcing a certain  state given a certain range of feature values
...
genome_dir = [rgasp_dir 'genomes/elegans/elegans.gio'];
anno_dir = [rgasp_dir 'annotations/elegans/'];
...
splice_site_dir = [data_dir 'elegans.6.bestpaired.filtered.bam.splice_pred/'];
acc_splice_dir = [splice_site_dir 'splice_acc.bspf/'];
don_splice_dir = [splice_site_dir 'splice_don.bspf/'];
...
read_map_file = [read_map_dir 'elegans.6.bestpaired.filtered.bam'];

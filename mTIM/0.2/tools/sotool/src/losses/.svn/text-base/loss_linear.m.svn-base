function [loss,idxs,params] = loss_linear(params, w, delta_y_ybar, delta_psis, delta_psis_idxs)
% Calculates the linear loss of given delta_psis and delta_y_y_bar-metric. 
% 

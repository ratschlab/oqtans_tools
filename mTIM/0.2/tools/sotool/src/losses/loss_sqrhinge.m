function [loss,idxs,params] = loss_sqrhinge(params, w, delta_y_ybar, delta_psis, delta_psis_idxs)
% Calculates the hinge loss of given delta_psis and delta_y_y_bar-metric. 
%
% 
...
% OUT
%   loss            : [1 x t], i=1,2,..,t
%                     loss_i=max(0,max_ybar(delta(y_i,ybar) -
%                     w'dPsis_i(ybar)))
...
losses = (delta_y_ybar - alpha*w'*delta_psis);
losses(losses<0) = 0;

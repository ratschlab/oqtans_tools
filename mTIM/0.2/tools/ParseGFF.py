...
def __main__():
    """This function provides a best way to extract genome feature 
       information from a GFF3 file for downstream processing.
    """
    try:
        gff_file = sys.argv[1]
        mat_file = sys.argv[2]
        ...
        print __doc__
        sys.exit(-1)
    sys.path.append('/mnt/galaxyTools/tools/oqtans/sw_require/lib/python2.6/site-packages/')
